/**
 * Safe bash extension for subagents.
 * Wraps the built-in bash tool with dangerous command blocking.
 *
 * Loaded into a child pi process when an agent's `tools` frontmatter lists
 * `safe_bash`. The parent extension resolves this file in getToolExtensionPath.
 */
...
export default function (pi: ExtensionAPI) {
  ...
  pi.registerTool({
    name: "safe_bash",
    label: "Safe Bash",
    description: "Execute bash while blocking common destructive commands.",
